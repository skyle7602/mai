...
local themeStyles = {
    ...
    BloodTheme = {
        SchemeColor = Color3.fromRGB(26, 66, 145),
        Background = Color3.fromRGB(26, 23, 26),
    ...
    Ro = {
        ...
        ElementColor = Color3.fromRGB(20, 20, 123)
    },
    Synapse = {
...
function Kavo.CreateLib(kavName, themeList)
    ...
    elseif themeList == "Ro" then
        themeList = themeStyles.Ro
